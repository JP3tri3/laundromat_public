...
class Ui:
    ...
    def start(self):
        ...
        input_quantity = 100 * leverage #set input quantity / contracts
        trade_id = 'bybit_manual' #set trade_id, for connection with database table
        ...
        while (flag == True):
            symbol_pair = input("Enter Symbol(btcusd or ethusd): ").upper()
